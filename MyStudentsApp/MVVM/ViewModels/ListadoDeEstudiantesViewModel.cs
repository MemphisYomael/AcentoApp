...
namespace MyStudentsApp.MVVM.ViewModels
{
    ...
    public class ListadoDeEstudiantesViewModel
    {
        ...
        {
            await _gestionUsuarioService.ObtenerEstudiantesAsync().ContinueWith(task =>
            {
                if (task.IsCompletedSuccessfully)
                {

                    Estudiantes = task.Result ?? new List<EstudianteResponseDTO>
            {
...
new EstudianteResponseDTO
                ...
                new EstudianteResponseDTO
                {
                   ...
                   curso = "10th Grade"
                    ...
                    // Manejar el error de la tarea aquí, por ejemplo, mostrar un mensaje de error.
                    Console.WriteLine("Error al obtener los estudiantes: " + task.Exception?.Message);
                }
            });
        }
    }
